        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, helper_service_1.helper.connectModel('user')];
                    case 1:
    ...
    UserController.prototype.register = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.checkUsernameIsExists(data.username)];
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, new Promise(function (resovle, reject) {
                                ...
                                helper_service_1.helper.modelCreate(_this.userModel, data)
